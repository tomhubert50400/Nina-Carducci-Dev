!(function (a) {
  (a.fn.mauGallery = function (t) {
    ...
    (a.fn.mauGallery.methods = {
      ...
      prevImage(t) {
        let e = null,
          l = a(`#${t}`).find(".lightboxImage").attr("src");
        a("img.gallery-item").each(function () {
          a(this).attr("src") === l && (e = a(this));
        });
        let i = a(".tags-bar span.active-tag").data("images-toggle"),
          s = [];
        "all" === i
          ? a(".item-column").each(function () {
              a(this).children("img").length && s.push(a(this).children("img"));
            })
          : a(".item-column").each(function () {
              a(this).children("img").data("gallery-tag") === i &&
                s.push(a(this).children("img"));
            });
        let n =
          (s.findIndex((a) => a.attr("src") === e.attr("src")) - 1 + s.length) %
          s.length;
        a(".lightboxImage").attr("src", s[n].attr("src"));
      },
      nextImage(t) {
        let e = null,
          l = a(`#${t}`).find(".lightboxImage").attr("src");
      ...
      filterByTag() {
        if (!a(this).hasClass("active-tag")) {
          a(".nav-link").removeClass("active-tag"),
